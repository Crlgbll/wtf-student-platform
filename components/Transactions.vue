<template>
  <div class="h-96 w-full overflow-y-auto">
    ...
    <div
      class="max-h-[500px] h-24 w-[350px] flex justify-center border-t-[1px] pt-3 border-[#5E5D5D] mx-auto overflow-y-scroll"
    ...
    async transaction() {
      try {
        const response = await fetch(
          "https://wtf-backend-production.up.railway.app/api/logs/211-00121"
        );
